                ...
                <div className="flex flex-wrap border-gray-100 border-b pb-20">
                    ...
                    <div className="w-full px-4 lg:w-1/2 lg:mt-20">
                        ...
                        <h2 className="lg:text-4xl text-[24px] text-black mt-1 font-semibold">
                            Tentang{" "}
                            <span className="text-primary">Gemasting</span>
                        </h2>
                        <p className="text-sm lg:text-base mt-[30px] mb-[20px] text-gray-300">
                            Gemasting merupakan inovasi berbasis mobile apps
                            untuk menggerakan masyarakat (ibu dan bayi) sehingga
                            sadar akan bahaya stunting (balita gagal tumbuh dan
                            kembang). Edukasi ini dilakukan melalui pola asuh
                            hidup sehat kepada ibu dan balita di Indonesia
                            sehingga terciptanya generasi cerdas.{" "}
                        </p>
                        <p className="text-sm lg:text-base text-gray-300">
                            Indonesia sudah saatnya memiliki generasi dengan
